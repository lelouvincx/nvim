    ...
    opts = function()
        ...
        return {
            ...
            prompts = {
                ...
                Implement = {
                    prompt = "> /COPILOT_GENERATE\n> #buffer\n\nBased on what I have provided, I need to implement a specific functionality in. It's your task to ask me about the functionality, programming language, and key requirements.\n\nPlease consider:\n- Error handling\n- Edge cases\n- Performance optimization\nBest practices\nPlease do not unnecessarily remove any comments or code.\nGenerate the code with clear comments explaining the logic.",
                },
            },
        }
    end,
